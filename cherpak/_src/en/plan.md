...
- [x] **Our own photos in place.** Six pictures of us at work (`foto-*.jpg`) are used on the front page and the sub-pages – lamp, bathroom, sofa cleaning, kitchen, cushions and floor. The stock photo of sofa cleaning has been replaced with our own.
...
> **About the price:** DKK 325/hour incl. VAT (260 ex) with a 3-hour minimum per visit and free travel only within Aalborg Municipality was set following the [competitor analysis](analyse.html), sections 4–5. It gives roughly +DKK 25 per billable hour for a new employee on the collective agreement – thin, but positive. Aim for DKK 349 once the first 10 reviews are in. Have the accountant work out pension and other employer contributions precisely. The full calculation is in [How we work out our price](priser.html) – in Danish, English and Russian, so all three of us can explain it.
...
- [ ] **New team photo when we get polo shirts with the logo.** Save it as `husfeerne-team.jpg` in the root folder – it is used in three places (hero, "Our approach", "Meet the team") and as the image when sharing on social media. The current photo has no logo on the clothing.
