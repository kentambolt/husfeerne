...
UI = {
  'da': dict(
    ...
    titler={'plan': 'Kom-i-gang-plan', 'analyse': 'Konkurrentanalyse', 'priser': 'Sådan er vores priser'},
    blurbs={'plan': 'Fase for fase: hvad der skal på plads, før og efter vi går i luften.',
            'analyse': 'Hvad konkurrenterne i Aalborg tager, hvad de sælger på – og hvorfor vi står, hvor vi står.',
            'priser': 'Vores priser, hvad en time koster os, og hvor vi ligger i markedet – så alle tre kan forklare det.'}),
  'en': dict(
    ...
    titler={'plan': 'Getting-started plan', 'analyse': 'Competitor analysis', 'priser': 'Our prices – and why'},
    blurbs={'plan': 'Phase by phase: what needs to be in place before and after launch.',
            'analyse': 'What competitors in Aalborg charge, what they sell on – and why we stand where we do.',
            'priser': 'Our prices, what an hour costs us, and where we sit in the market – so all three of us can explain it.'}),
  'ru': dict(
    ...
    titler={'plan': 'План запуска', 'analyse': 'Анализ конкурентов', 'priser': 'Наши цены — и почему'},
    blurbs={'plan': 'Шаг за шагом: что должно быть готово до запуска и после.',
            'analyse': 'Что берут конкуренты в Ольборге, на чём они продают — и почему мы стоим там, где стоим.',
            'priser': 'Наши цены, сколько нам стоит час и где мы на рынке — чтобы каждый из нас троих мог это объяснить.'}),
}
